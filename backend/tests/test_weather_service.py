...
class TestWeatherService(unittest.TestCase):
    ...
    def test_fetch_weather_data_invalid_coordinates(self):
        print(" A Realizar : Teste de coordenadas inválidas para dados meteorológicos...")
    ...
    def test_needs_irrigation_true(self):
        print(" A Realizar : Teste de necessidade de irrigação (verdadeiro)...")
    ...
    def test_needs_irrigation_false(self):
        print(" A Realizar : Teste de necessidade de irrigação (falso)...")
    ...
    def test_risk_of_fungi_true(self):
        print(" A Realizar : Teste de risco de fungos elevado...")
    ...
    def test_risk_of_fungi_false(self):
        print(" A Realizar : Teste de risco de fungos baixo...")
    ...
    def test_suggest_harvest_time_good_harvest(self):
        print(" A Realizar : Teste de sugestão de colheita com condições favoráveis...")
    ...
    def test_suggest_harvest_time_bad_temp(self):
        print(" A Realizar : Teste de sugestão de colheita com temperatura desfavorável...")
    ...
    def test_fetch_forecast_invalid_coordinates(self):
        print(" A Realizar : Teste de previsão meteorológica com coordenadas inválidas...")
